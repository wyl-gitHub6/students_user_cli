...
import VueCropper from "vue-cropperjs";//图片裁剪
...
export default {
    ...
    setup() {
        ...
        const name = JSON.parse(sessionStorage.getItem("teacher")).teacherName;
        let form = reactive({
            old: "",
            new: "",
            desc: "为人师表，无私奉献",
        ...
        const onSubmit = () => {
            ...
            request.get('/api/teacher/updatePassword',{
                params:{
                ...
                teacher.teacherPassword = form.new
                request.put('api/teacher/update',teacher).then(res=>{
                    if (res.code == 0){
                        ElMessage.success({
                            message: '密码修改成功!',
                            type: 'success'
